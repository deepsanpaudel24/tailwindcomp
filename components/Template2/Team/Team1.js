        ...
        <div class="flex flex-wrap -m-4">
          <div class="w-full md:w-1/2 lg:w-1/3 p-4">
            <div class="relative pt-14 bg-white shadow rounded overflow-hidden">
              ...
              <img
                class="absolute top-0 left-0 w-full h-24 object-cover"
                src="https://images.unsplash.com/photo-1592580119984-d31e3833fa78?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=80"
              />
              <img
                class="relative w-16 h-16 mb-4 mx-auto rounded-full object-cover object-right"
              ...
              <div class="px-6 text-center">
                <h3 class="font-medium">Jane Thomas</h3>
                ...
                <div class="flex items-center justify-center mb-6">
                  ...
                  <p class="text-sm">jane.thomas@shuffle.dev</p>
                </div>
                <div class="mb-6">
                  <a
                    class="inline-flex items-center justify-center mr-6 w-10 h-10 bg-gray-50 rounded-full"
                    href="#"
                  >
                    <svg
                      width="18"
                  ...
                  <a
                    class="inline-flex items-center justify-center w-10 h-10 bg-gray-50 rounded-full"
                    href="#"
                  >
                    <svg
                      width="16"
                ...
                <div class="mb-6">
                  <a class="py-1 px-2 mr-2 text-xs rounded border" href="#">
                    Front-End
                  </a>
                  <a class="py-1 px-2 mr-2 text-xs rounded border" href="#">
                    Design
                  </a>
                  <a class="py-1 px-2 text-xs rounded border" href="#">
                    Product Development
                  </a>
                </div>
              </div>
              <button class="block w-full py-4 border-t border-gray-50 text-xs text-gray-500 hover:text-gray-800 uppercase">
                View Profile
              </button>
            </div>
          </div>

          ...
          <div class="mx-auto py-10 bg-white shadow rounded">
            <div class="max-w-5xl p-4 flex flex-wrap justify-center items-center">
              <div class="mb-6 w-full lg:w-1/3 text-center">
                <img
                  class="mb-6 mx-auto w-32 h-32 rounded-full object-cover"
                  ...
                  alt=""
                />
                <h4 class="text-xl">Ian Brown</h4>
                <p class="text-purple-600">Head of Development</p>
              </div>
              <div class="w-full lg:w-2/3">
                <svg
                  class="mb-4 text-purple-600 h-10"
                  viewbox="0 0 32 28"
                  fill="none"
                ...
                <h3 class="mb-6 text-3xl lg:text-4xl font-bold font-heading">
                  Maecenas nibh purus, pharetra ac felis sed, elementum molestie
                  urna. Nunc at arcu non ipsum.
                </h3>
                <div>
                  <button class="mr-1 bg-gray-200 rounded-full p-1"></button>
                  <button class="mr-1 bg-gray-200 rounded-full p-1"></button>
                  <button class="mr-1 bg-purple-600 rounded-full p-1"></button>
                  <button class="bg-gray-200 rounded-full p-1"></button>
                </div>
              </div>
            </div>
          </div>

        ...
        <div class="flex flex-wrap -mx-4 mb-20 items-center justify-between">
          <div class="w-full lg:w-auto px-4 mb-12 xl:mb-0">
            <h2 class="text-5xl font-bold font-heading">
              ...
              <a class="relative text-blue-300 underline" href="#">
                Sports
              </a>
            </h2>
          </div>
        ...
        <div class="flex flex-wrap -mx-3 mb-24">
            ...
            <div class="flex flex-wrap -mx-2">
              ...
              <div class="w-1/2 md:w-1/3 px-2 mb-4">
                <div class="py-6 px-4 text-center bg-gray-50">
                  ...
                  <div class="hidden mt-6 flex flex-wrap -mx-2 -mb-2">
                    <button class="mb-2 mr-1 w-16 py-1 border hover:border-gray-400 rounded-md">
                      36
                    </button>
                  ...
                  <div class="hidden mt-4 text-right">
                    <a
                      class="inline-flex underline text-blue-300 hover:text-blue-400"
                      href="#"
                    >
              ...
              <div class="w-1/2 md:w-1/3 px-2 mb-4">
                <div class="py-6 px-4 text-center bg-gray-50">
                  ...
                  <input
                    class="hidden mt-6 w-full px-8 py-4 bg-white border rounded-md"
                    type="serach"
                    placeholder="City"
                  />
                </div>
          ...
          <div class="hidden lg:block w-1/4 pl-3 pr-8">
            ...
            <div class="mb-6 py-10 border-b border-gray-900">
              ...
              <div>
                <input
                  class="w-full mb-4 outline-none appearance-none bg-gray-200 h-1 rounded cursor-pointer"
                  type="range"
                  min="1"
                  max="100"
                  value="50"
            ...
            <div class="mb-6 py-10">
              <h3 class="mb-6 text-2xl font-bold font-heading">Location</h3>
              <input
                class="w-full px-8 py-4 bg-white border rounded-md"
                type="serach"
                placeholder="City"
              />
            </div>
